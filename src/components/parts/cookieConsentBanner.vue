...
<template>
  <div v-if="!generalFunction.cookieConsentStatus" class="flex justify-center items-center fixed bottom-0 left-0 w-full h-44 bg-slate-50 border-t-2 border-slate-100">
